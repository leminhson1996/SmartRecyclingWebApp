		...
		<div class="container">
				<div class="single-top">
    				...
    				<div class="comment-bottom heading">
    					...
    					<form>	
							<input type="text" value="Tên của bạn" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Name';}">
							<input type="text" value="Email của bạn" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Email';}">
							<input type="text" value="Chủ đề" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Subject';}">
							<textarea cols="77" rows="6" value=" " onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Message';}">Lời nhắn<textarea>
